...
const navItems = [
  ...
  { icon: MessageSquarePlus, label: "Raise Complaint", path: "/user/dashboard/raise-complaint" },
  { icon: ClipboardList, label: "My Complaints", path: "/user/dashboard/my-complaints" },
  { icon: Bell, label: "Notices", path: "/user/dashboard/notices" },
  { icon: Phone, label: "Emergency Contact", path: "/user/dashboard/emergency-contact" },
  { icon: Wrench, label: "Book Amenity", path: "/user/dashboard/book-amenity" },
